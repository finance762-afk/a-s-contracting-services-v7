...
// Entity type not provided in build-plan.json — placeholder
...
<article class="legal-prose">
  ...
  <ul>
    ...
    <li><strong>Subcontractors and material suppliers:</strong> as necessary to complete your project (though A&S Contracting Services self-performs most work).</li>
