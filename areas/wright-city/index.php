<?php
/**
 * Wright City, MO Service Area Page
 *
 * Research sources:
 * - https://en.wikipedia.org/wiki/Wright_City,_Missouri
 * - https://www.plantmaps.com/hardiness-zones-for-warren-county-missouri
 * - https://www.nps.gov/places/southwestern-bell-repeater-station.htm
 *
 * Verified local details:
 * - Elevation: 732 ft (223 m)
 * - Location: Warren County (same county as Warrenton)
 * - I-70 at mile marker 200, ~50 miles west of downtown St. Louis
 * - Named after Dr. Henry C. Wright, first settler (laid out 1857)
 * - Southwestern Bell Repeater Station (National Register, 2007)
 * - Semi-rural, primarily single-family housing
...
<section class="hero--area">
  <div class="container">
    <nav class="breadcrumb" aria-label="Breadcrumb">
      ...
      <span class="breadcrumb-sep" aria-hidden="true">/</span>
      <span>Wright City</span>
    </nav>

    <div class="eyebrow">Warren County Home Base</div>
    <h1>General Contracting in <span class="text-accent">Wright City, Missouri</span></h1>
    <p class="hero-answer">
      A&S Contracting Services is a licensed Missouri general contractor based in Warren County, serving
      Wright City homeowners with self-performed roofing, siding, gutters, and full-scale renovations—no
      subcontractors, same crew start to finish. As the closest incorporated city to our Warrenton base,
      we respond to Wright City properties faster than anyone.
    </p>
...
<!-- Why Wright City Homeowners Choose Us -->
<section class="section-light">
  <div class="container">
    <div class="split-grid">
      <div class="prose">
        <h2 class="section-title">Why Wright City Homeowners Choose A&S Contracting</h2>
        <p>
          <strong>A&S Contracting Services is a licensed and insured general contractor based in Warrenton, Missouri,</strong>
          serving Wright City and surrounding Warren County communities with self-performed roofing, siding, gutters,
          drywall, and full-scale renovations.
        </p>
        <p>
          Wright City sits at approximately <strong>732 feet elevation</strong> along I-70 at mile marker 200, about
          50 miles west of downtown St. Louis, in <strong>USDA Zone 6b-7a</strong> with winter lows between -5°F and 5°F.
          This semi-rural Warren County community, laid out in 1857 by Dr. Henry C. Wright, sees the full force of
          Missouri's seasonal extremes—freeze-thaw cycles stress roof shingles, wind-driven rain tests siding seals,
          and temperature swings demand properly vented attics and functional gutters.
        </p>
        <p>
          We understand these conditions because we're your neighbors. Every crew member is a direct A&S employee—no
      ...
      <div class="prose">
        <h3>Warren County's Closest Contractor</h3>
        <p>
          Wright City's location in the <strong>Township of Hickory Grove</strong> puts it at the heart of Warren County's
          residential growth corridor. Homes here range from historic properties dating to the city's 1857 founding to
          modern subdivisions built over the past two decades. We've worked on both—preserving rooflines on century-old
          farmhouses and executing builder-grade upgrades on newer construction throughout the community.
        </p>
        <p>
          The <strong>Southwestern Bell Repeater Station</strong> (added to the National Register in 2007) represents
          Wright City's historical role along the I-70 corridor, and that central location means efficient service for
          homeowners here. Our crews typically arrive within 20 minutes for estimates and service calls.
        </p>
        <p>
...
<!-- Services in Wright City -->
<section class="section-dark">
  <div class="container">
    <h2 class="section-title">Services Available in Wright City</h2>
...
<section class="cta-band">
  <div class="container">
    <h2>Ready to Get Started in Wright City?</h2>
    <p>
